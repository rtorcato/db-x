// Env loading + connection settings for the CockroachDB todos demo. Split out
// of `dbx.tsx` so the entry file is nothing but the component tree — the JSX
// is what the example is teaching; dotenv plumbing is not.
